...
<div class="fixed-scroll">
	<div style="margin: 150px auto;">
		...
		<div class="store_top">
			...
			<img src="resources/img/로고.png" onclick="window.location.href='/root'">
			<div>
		...
		<div class="store_name">
		    ...
		    <img src="resources/img/별.png" width="15px"> 4.3 &nbsp;&nbsp;&nbsp;
		    리뷰 <a href=""><span style="color: #397BE6;">135</span></a> &nbsp;&nbsp;&nbsp;
		    <img src="resources/img/하트.png" width="15px"> 32
		    <br><br>
		...
		<div class="review-photo">
			<img src="resources/img/결01_4.jpg">
			<img src="resources/img/결02.jpg">
			<img src="resources/img/결02_2.jpg">
			<img src="resources/img/결02_3.jpg">
		</div>
